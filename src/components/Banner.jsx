          ...
          <div className="bg-white p-10 rounded-lg shadow-lg w-96 relative">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-medium">9165754985</span>
                  <button
                    className="text-purple-600 hover:text-purple-700"
                    onClick={() => copyToClipboard("9165754985")}
                  >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="font-medium">Alfred Ayomide Ayilara</span>
                  <button
                    className="text-purple-600 hover:text-purple-700"
                    onClick={() => copyToClipboard("Alfred Ayomide Ayilara")}
                  >
                  </button>
                </div>
              </div>
